...
public class BalloonBroTextTriggerScript : MonoBehaviour {
	
	public int toMakeActive;
	public BoutierManagerScript bms = null;
	...
	void Update () {
		...
		if(xa.player){
			...
			if(inMe && !triggered){
				bms.balloonTexts[toMakeActive].SetActive(true);
				triggered = true;
			}
		}
	}
